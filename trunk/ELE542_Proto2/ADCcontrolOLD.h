...
void calibrateMotors(void)
{
	...
	for (i=0;i<CAL_SAMPLES;i++){
		...
		compileAdcData();
		//waitValueIsReady();
		leftLimits.posMax += adcValues.left * MAX_ADC_VALUE;
	}
	leftLimits.posMax = leftLimits.posMax / CAL_SAMPLES;
	...
	leftLimits.posZero = leftLimits.posZero / CAL_SAMPLES;	
	...
	leftLimits.negMax = leftLimits.negMax / CAL_SAMPLES;
	...
	rightLimits.posMax = rightLimits.posMax / CAL_SAMPLES;
	...
	rightLimits.posZero = rightLimits.posZero / CAL_SAMPLES;
	...
	rightLimits.negMax = rightLimits.negMax / CAL_SAMPLES;
	...
	rightLimits.negZero = rightLimits.negZero / CAL_SAMPLES;
